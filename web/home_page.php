...
<!--            <td><input type="text" name="name" value="" size="50" maxlength="500"/></td>  -->
    ...
    <table style="border:1px solid black; border-collapse:collapse;">
      <tr>
        ...
        <th colspan="1" style="vertical-align:top; border:1px solid black; background: lightgreen;"></th>
        <th colspan="6" style="vertical-align:top; border:1px solid black; background: lightgreen;">Statistic Averages</th>
      </tr>
      <tr>
            ...
            if ($item->hasStat()) {
              echo '
               <tr>
                 ...
                 <td  style="vertical-align:top; border:1px solid black;">' . '<button>Edit Address</button></td>'
               . '</tr>';
            } 
            else {
              echo '
...
>>>>>>> 1b6d3bf54857deb78760ba56f8823db9adf663e0
